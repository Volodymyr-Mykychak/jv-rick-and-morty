...
public class CharacterController {
    ...
    @GetMapping("/random")
    @Operation(summary = "Get a random character", description = "Returns a random character "
                                                                 + "from" + " the database")
    ...
    @GetMapping("/search")
    @Operation(summary = "Search characters by name", description = "Search and return a list of "
                                                                    + "characters whose " + "name"
                                                                    + " " + "contains the search "
                                                                    + "string")
    public List<ExternalCharacterDto> searchCharactersByName(
